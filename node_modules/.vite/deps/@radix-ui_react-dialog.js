...
var FocusScope = React8.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Primitive.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime5.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React21.Children.map(children, (child) => (0, import_jsx_runtime5.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime5.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlayImpl = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime5.jsx)(Combination_default, { as: Slot, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime5.jsx)(
        Primitive.div,
        {
          "data-state": getState(context.open),
          ...overlayProps,
